...
def create_graph(tools: list):
    ...
    prompt_template = ChatPromptTemplate.from_messages([
        ("system", "You are a helpful assistant. You are a helpful assistant that can analyze images. Use the tools when necessary based on the user's request."),
...
async def main():
    ...
    print("The image assistnat is ready")
