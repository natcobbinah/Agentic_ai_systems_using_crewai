...
os.environ["OPEN_API_KEY"] = 'ADD YOUR API KEY HERE'
...
research_analyst_agent = Agent(
    ...
    backstory="Specializing in research analysis, this agent employs advanced methodologies to generate detailed research points \
        and insights. With a deep understanding of research frameworks and a talent for synthesizing \
        information, the Research Analyst is instrumental in delivering thorough and actionable research outcomes",
    verbose=True,
...
report_editor_agent = Agent(
    ...
    backstory="With a keen eye for detail and a strong background in report editing, this agent ensures that\
        research reports are polished, coherent, and meet high-quality standards. Skilled in revising content \
...
research_crew=Crew(
    ...
    tasks=[data_collection_task, data_analysis_task, report_assessment_task],
    manager_llm=llm,
